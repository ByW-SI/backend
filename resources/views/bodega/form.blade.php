		...
		<div class="row justify-content-center">
			<div class="col-md-10">
				<div class="card">
					...
					<div class="card-body">
						<form method="POST" action="{{ $edit == false ? route('bodegas.store') : route('bodegas.update',['bodega'=>$bodega]) }}" enctype="multipart/form-data">
							@csrf
...
{{-- enologo --}}
							<div class="form-group row">
								...
								<div class="col-md-6">
									<select id="enologo_id" class="form-control {{ $errors->has('enologo_id') ? ' is-invalid' : ''  }}" name="enologo_id">
...
{{-- Wine Maker --}}
							<div class="form-group row">
								...
								<div class="col-md-6">
									<select id="wine_maker_id" class="form-control {{ $errors->has('wine_maker_id') ? ' is-invalid' : ''  }}" name="wine_maker_id">
