										...
										<div class="row">
											...
											<div class="col-12 col-md-4">
												...
												<input id="nombre" type="text"
													...
													name="nombre"
													value="{{ $edit ? $productor->nombre : old('nombre') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="apellido_paterno" type="text"
													...
													value="{{ $edit ? $productor->apellido_paterno : old('apellido_paterno') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="celular" type="number"
													...
													name="celular"
													value="{{ $edit ? $productor->celular : old('celular') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="correo" type="email"
													...
													name="correo"
													value="{{ $edit ? $productor->correo : old('correo') }}" required autofocus="">
										...
										<div class="row">
											...
											<div class="col-12 col-md-4">
												...
												<input id="calle" type="text"
													...
													name="calle" value="{{ $edit ? $productor->calle : old('calle') }}" required autofocus="">
												@if ($errors->has('calle'))
												{{-- expr --}}
												<span class="invalid-feedback">
											...
											<div class="col-12 col-md-4">
												...
												<input id="num_exterior" type="text"
													...
													name="num_exterior"
													value="{{ $edit ? $productor->num_exterior : old('num_exterior') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="num_interior" type="text"
													...
													name="num_interior"
													value="{{ $edit ? $productor->num_interior : old('num_interior') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="localidad" type="text"
													...
													name="localidad"
													value="{{ $edit ? $productor->localidad : old('localidad') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="ciudad" type="text"
													...
													name="ciudad"
													value="{{ $edit ? $productor->ciudad : old('ciudad') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="municipio" type="text"
													...
													name="municipio"
													value="{{ $edit ? $productor->municipio : old('municipio') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="estado" type="text"
													...
													name="estado"
													value="{{ $edit ? $productor->estado : old('estado') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="codigo_postal" type="number"
													...
													value="{{ $edit ? $productor->codigo_postal : old('codigo_postal') }}" required autofocus="">
										...
										<div class="row">
											...
											<div class="col-12 col-md-4">
												...
												<input id="nombre_empresa" type="text"
													...
													name="nombre_empresa"
													value="{{ $edit ? $productor->nombre_empresa : old('nombre_empresa') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="telefono_empresa" type="text"
													...
													value="{{ $edit ? $productor->telefono_empresa : old('telefono_empresa') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="sitio_web_empresa" type="text"
													...
													value="{{ $edit ? $productor->sitio_web_empresa : old('sitio_web_empresa') }}" required autofocus="">
											...
											<div class="col-12 col-md-4">
												...
												<input id="fecha_inicio_operaciones_empresa" type="date"
													...
													value="{{ $edit ? $productor->fecha_inicio_operaciones_empresa : old('fecha_inicio_operaciones_empresa') }}" required autofocus="">
										...
										<div class="row">
											...
											<div class="col-12 col-md-4 mt-3">
												...
												<input id="anio_inicio_actividades" type="text"
													...
													value="{{ $edit ? $productor->anio_inicio_actividades : old('anio_inicio_actividades') }}" required autofocus="">
											...
											<div class="col-12 col-md-4 mt-3">
												...
												<input id="semblanza_profesional" type="text"
													...
													value="{{ $edit ? $productor->semblanza_profesional : old('semblanza_profesional') }}" required autofocus="">
